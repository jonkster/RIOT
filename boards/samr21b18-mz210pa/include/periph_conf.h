...
static const uart_conf_t uart_config[] = {
    ...
    {&SERCOM1->USART, GPIO_PIN(PA,19), GPIO_PIN(PA,18), GPIO_MUX_C, 3U, 1U}, //sercom 1 pad3 = rx, pad2 = tx
    {&SERCOM2->USART, GPIO_PIN(PA,15), GPIO_PIN(PA,14), GPIO_MUX_C, 3U, 1U}, //sercom 2 pad3 = rx, pad2 = tx
};

/* interrupt function name mapping */
#define UART_0_ISR          isr_sercom1
